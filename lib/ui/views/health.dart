...
import 'package:devops_demo/ui/views/ousregistration.dart';
    ...
    ListTile makeListTile(Services services) => ListTile(
      ...
      onTap: () {
        switch (services.title) {
          case Strings.TITLE_OUS_CRT_APPT:
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => OUSRegistration()));
            break;
          default:
            break;
        }
...
List getServices() {
  return [
    Services(
      title: Strings.TITLE_OUS_CRT_APPT,
      indicatorValue: 0.25,
    ),
    Services(
      title: Strings.TITLE_OUS_VW_APPT,
      indicatorValue: 0.50,
    ),
    Services(
      title: Strings.TITLE_OUS_REGISTRATION,
      indicatorValue: 0.75,
    ),
    Services(
      title: Strings.TITLE_OUS_APPTS,
      indicatorValue: 1.0,
    ),
  ];
}
